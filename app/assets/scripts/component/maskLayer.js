...
define(['jquery'], function ($) {
    ...
    MaskLayer_.prototype.render = function () {
        ...
        this.container[this.config.appendType](maskBox);
    ...
    MaskLayer_.prototype.appendBody = function () {
        this.maskBox.remove();
        this.container[this.config.appendType](this.maskBox);
        return this;
    };
   ...
   return function (config) {
       ...
       maskLayer = $(config.container).data('data-maskLayer');

        if (maskLayer) {
            maskLayer.appendBody();
        } else {
            $(config.container).data('data-maskLayer', maskLayer = new MaskLayer_(config));
        }
        return maskLayer;
    };
